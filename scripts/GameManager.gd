...
const MAP_DEFS := {
	"level_1": {
		...
		"traits": [
			...
			"Slimes take over from 8:00 (500 HP) as the surge eases back off",
			"The surge returns from 10:30, four times the rate by 11:00",
			"At 15:01 the Reaper comes for you",
		],
